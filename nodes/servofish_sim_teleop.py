#!/usr/bin/env python
""" 
This node takes joystick commands, simulates an Artemis SS-style single-hinge fish robot, and publishes
...
class PosePublisher():
    def __init__(self):
        ...
        self.tailref = 0.
        self.dT = 0.005#this is how fast the simulation loop will run.
        ...
        #publishers
        self.posepub = rospy.Publisher('/fishpose',PoseStamped,queue_size=1)
        self.tailposepub = rospy.Publisher('/tailpose',PoseStamped,queue_size=1)
